...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        @Override
        public void onClick(View view) {
            String key = clientAddressEditText.getText().toString();
            String value = clientPortEditText.getText().toString();
            ...
            clientThread = new ClientThread(
                    "127.0.0.1", Integer.parseInt(port), key, value, "Put", weatherForecastTextView
            );
            clientThread.start();
        }
    ...
    private class PutButtonClickListener implements Button.OnClickListener {
        @Override
        public void onClick(View view) {
            String getKey = clientGetKey.getText().toString();
            ...
            clientThread = new ClientThread(
                    "127.0.0.1", Integer.parseInt(port), getKey, "None", "Get", weatherForecastTextView
            );
            clientThread.start();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clientGetKey = (EditText)findViewById(R.id.client_get_key);
